...
import co.edu.unbosque.apeh.repository.HorarioElectivoRepositoryCRUD;
...
public class HorarioElectivoController {
	@Autowired
	private HorarioElectivoRepositoryCRUD horarioElectivoRepositoryCRUD;
	...
	public String agregarMateria(@RequestBody Horario horario) {
		HorarioElectivoModel hor = new HorarioElectivoModel();
		String aux = "";
        ...
        if (user != null && user.getRole().equals(Role.ADMIN)) {
    		...
    		hor.setStatus(true);
    		horarioElectivoRepositoryCRUD.save(hor);
    		aux = "Saved";
        } else {
	...
	public String cambiarEstado() {
		horarioElectivoRepositoryCRUD.cambioEstado();
		return "Cambio Exitoso";
	}
	
	@GetMapping(path="/borrar")
	public String borrar() {
		horarioElectivoRepositoryCRUD.borrarAnterior();
		return "Se borró con éxito";
	}
	
    @GetMapping("/active")
    public List<HorarioElectivoModelDTO> getActiveClasses() {
        return horarioElectivoRepositoryCRUD.traerHorario();
    }
}
